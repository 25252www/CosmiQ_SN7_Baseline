...
# # colors
# vmax = 200
# cmap = plt.get_cmap('hsv')  # 'jet' 选择一种colorbar，范围0-1
# cNorm  = colors.Normalize(vmin=0, vmax=vmax) # 将0-200归一化到0-1 然后取colorbar中的颜色 
...
#     fig, ax = plt.subplots(figsize=figsize) # 根据figsize创建一个子图
